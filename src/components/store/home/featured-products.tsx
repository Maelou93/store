        ...
        <div className="flex items-end justify-between mb-12">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="w-10 h-10 border border-stone-300 hover:border-[#493A2E] hover:text-[#6B5848] text-stone-500 transition-all duration-300 flex items-center justify-center"
